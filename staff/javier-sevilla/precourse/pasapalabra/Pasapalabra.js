...
function presentacionJuego() {
    alert("-----Bienvendido al juego PASALACABRA----" + "\n" +
      "\n A continuación se explican las reglas del juego:" + 
      "\n 1- Obtendrá un punto por cada letra acertada " + 
      "\n 2- Tendrá un máximo de tres rondas para acertar la palabra" +
      "\n 3- Solamente hay una respuesta correcta y tendrá que ser exactamente esa" +
      "\n 4- Puede pasar el turno introduciendo 'pasalacabra' o pulsando cancelar" +
      "\n 5- Puede finalizar introduciendo la palabra 'end'" +
      "\n " + "\n SUERTE AMIGO Y PÉTALO!")       
 };
...
function PreguntarLetras() {
   ...
   let totalFails = 0;
   let turno = 0;
   let noFinQuestion = true;
   let finTurno = true;
   do {
      turno = turno + 1
      for (i = 0; i < preguntas.length; i++) {
           if (preguntas[i].status === 0) {
               answer = prompt("Turno : " + turno + "\n" + preguntas[i].question)
               console.log()
               if (answer === null) {
                  answer = "pasalacabra";
               }
               ...
               if (answer === "end") {
                   alert("Ha acetado un total de: " + totalPoints + " palabras" + 
                         "\nHa fallado un total de: " + totalFails + " palabras")
                   totalPoints = 99
                   return totalPoints;
               } else if (answer === "pasalacabra") {
                   alert("SIGUE PENSADO!");   
               } else if (answer === preguntas[i].answer) {
                   alert("ACERTADA!");
                   totalPoints = totalPoints + 1 
                   preguntas[i].status = 1;
               } else {
                   alert("FALLADA!" + "\nRespuesta correcta--> " + preguntas[i].answer);
                   totalFails = totalFails + 1 
                   preguntas[i].status = 99;
               };
            };
      };
      finTurno = true
